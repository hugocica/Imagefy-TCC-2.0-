...
% \label{s.cloudinary}
%
% Cloudinary é um outro serviço online, de modo que pode ser integrado a um sistema ou aplicativo através de sua API. Nele, é possível armazenar imagens, de modo que ele pró
